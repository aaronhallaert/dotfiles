...
vim.api.nvim_set_keymap('n', '<C-h>',
    ':lua require("harpoon.ui").toggle_quick_menu()<CR>', {noremap = true})
vim.api.nvim_set_keymap('n', '<leader>ah',
    ':lua require("harpoon.mark").add_file()<CR>', {noremap = true})
vim.api.nvim_set_keymap('n', '<leader>th',
    ':lua require("harpoon.mark").toggle_file()<CR>', {noremap = true})
