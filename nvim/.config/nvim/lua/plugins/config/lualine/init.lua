...
require("lualine").setup({
    ...
    sections = {
        ...
        lualine_c = {
            ...
            branch,
            diff,
            require("plugins.config.lualine.cmake").build_type,
            require("plugins.config.lualine.cmake").build_kit,
            require("plugins.config.lualine.cmake").build,
            require("plugins.config.lualine.cmake").build_dir,
            -- require("plugins.config.lualine-cmake").configure_preset,
            -- require("plugins.config.lualine-cmake").build_target,
            -- require("plugins.config.lualine-cmake").debug,
            -- require("plugins.config.lualine-cmake").run,
        },
        lualine_x = {
            space,
        },
