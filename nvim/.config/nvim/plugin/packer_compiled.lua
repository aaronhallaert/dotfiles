...
_G.packer_plugins = {
  ...
  ["continuous-testing.nvim"] = {
    config = { "\27LJ\2\n¨\1\0\0\4\0\6\0\t6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\4\0005\3\3\0=\3\5\2B\0\2\1K\0\1\0\17test_command\1\0\0\1\0\1\15ruby_rspecFrun_api.sh -ni -- spring rspec %file --format json --no-fail-fast\nsetup\23continuous-testing\frequire\0" },
    loaded = true,
